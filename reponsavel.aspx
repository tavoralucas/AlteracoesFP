...
<body id="responsavel">
	...
	<section  style="background-color: #b44146 !important;height: 1000px;">
		<div style="background-color: #b44146; display: flex; justify-content: center; border-color: #b44146;">
			<img src="imagens/logo_CURSO.png" class="imagemlogo" style="background: no-repeat;margin-top:-100px !important;"/>
		</div>
        <div style="margin-top: 50px; margin-bottom:50px;">        
            <div class="login-box card" id="pitoca">
