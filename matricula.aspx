...
-->
	...
	<section id="wrapper" >
		<div style="background-color: #b44146; display: flex; justify-content: center; border-color: #b44146;">
			<img src="imagens/logo_CURSO.png" class="imagemlogo" style="background: no-repeat;margin-top:40px !important;"/>
		</div>
        ...
        <div class="login-register" style="background-color:#b44146;border-color: #b44146;">
			<div class="avisos">
				...
				<p style="color: white; text-align:center;">Bem-vindo(a) ao sistema de matrículas do Curso Fernanda Pessoa</p>
			</div>
