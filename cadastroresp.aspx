...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
        ...
        <!-- ============================================================== -->
        <header class="topbar">
            <nav class="navbar-top" style="width: 100%; height: 50px; background-color: #B44146;"></nav>
        </header>
        <!-- ============================================================== -->
        <!-- End Topbar header -->
        <!-- ============================================================== -->
        ...
        <!-- Page wrapper  -->
        <!-- ============================================================== -->
        <div style="display: flex; justify-content: center; background-color: #B44146;margin-top:-50px;">
            <img src="imagens/logo_CURSO.png" alt="Logo Fernanda Pessoa" width="250px" style="margin-top:100px;margin-bottom:-2px;"></img>
        </div>
        <div class="page-wrapper" style="background-color: #B44146;">
            <!-- ============================================================== -->
            <!-- Container fluid  -->
            <!-- ============================================================== -->
            <div class="container">
                    ...
                    <div class="col-12">
                        <div class="card" style="border: 0px;">
                            ...
                            <div class="card-header" style="background: black !important; border-color: black !important;">
                                <h4 class="m-b-0 text-white">Cadastre o Responsável</h4>
                            </div>
